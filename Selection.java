...
/**
 * Demonstrate how to listen for changes to the selection state. Executing this
 * demo will present a window with a graph. As vertices are selected and unselected,  
 * the changes are sent to standard output.
 * 
 * http://kahdev.wordpress.com/2010/02/20/detecting-selection-of-vertices-in-jung/
 * 
 * @author Kah
 */
